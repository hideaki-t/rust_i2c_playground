* toy programs using Rust(currently beta or nightly needs to be used) and i2cdev to read temperature and relative humidity from Si7021 and to read data from TSL2560
